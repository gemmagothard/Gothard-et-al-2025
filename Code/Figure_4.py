...
def Figure4(
    ...
    y = 'Shared_output_prob'
    this_ax = ax[0]
    this_ax.set_xlabel(' ')
    this_ax.set_ylabel('Shared output probability ')
    ...
    plt.tight_layout()
    fig.savefig(os.path.join(savepath,'Fig_4.svg'))

    plt.show()


Figure4(datapath='/Users/gemmagothard/Library/CloudStorage/OneDrive-Nexus365/DPhil/Papers/Inhibitory_subnetwork_paper/PAPER TEXT/files for submission/2025 nature neuro/Gothard-et-al-github/Data/Fig_4_data.csv',
